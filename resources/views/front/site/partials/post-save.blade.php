    ...
    <div class="post-detail-1 post-detail" id="save_post_{{$post->id}}" data-p="{{$post->id}}" data-viewed="false">
        ...
        <div class="sec2">
            ...
            @if($post->media_type == "video")
                <video controls preload="auto" autoplay  muted controlslist="nodownload noremoteplayback noplaybackrate foobar" disablePictureInPicture src="{{url('storage/posts/'.$post->media."#t=1")}}">
